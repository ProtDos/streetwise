  ...
  <head>
    ...
    <script>
        function login(){
            ...
            const url = 'http://192.168.0.172:88/login';
            ...
            .then(json => {
              // Log the JSON data to the console
                if (json.message == "Invalid username or password.") {
                    ...
                    alert("Logged in.");
                    // window.location.replace("http://denter.de");
                }
              console.log(json);
            })
            .catch(error => {
          ...
          <div class="w-full flex-1 mt-8">
            ...
            <div class="mx-auto max-w-xs">
              ...
              >
                ...
                <a href="signup.html" class="border-b border-gray-500 border-dotted">
                  Create now!
                </a>
              </p>
